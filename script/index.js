...
for (let i = 1; i <= 9; i++) {
    let btn = document.getElementById("cart-call" + i);
    let title = document.getElementById("cart-title" + i);
    let num = document.getElementById("cart-num" + i);
        ...
        btn.addEventListener("click", function () {
            ...
            if (coin >= 20) {
                ...
                <div class="flex justify-between">
                    <div>
                        <p class="font-semibold text-[14px]">${name}</p>
